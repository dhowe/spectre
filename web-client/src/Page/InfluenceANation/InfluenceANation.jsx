    ...
    return (
      <div className={classes.root}>
          ...
          <div className={classes.content + " content"}>
              ...
              <Typography component="h4" variant="h4">Lets increase the {this.context.virtue||'influence'} of your campaign to convince lots of people to vote {this.context.brexitChoice} in the referendum.</Typography>

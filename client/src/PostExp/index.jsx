    ...
    return (
      <div className="PostExp">
          ...
          <section id="section-1">
              <div className="row bg-1">
                  <ContentCol>
                      ...
                      <p>Be honest, did you really read the full Terms of Service agreement and privacy ‘policy’? Don’t worry if not, you are in the majority if not. Spectre takes privacy seriously as it can be very bad for business. If it is easy and uncomplicated for you to setup strong privacy controls, we get less of your data. So we use ‘dark design’ to influence your choice when considering privacy settings and especially when signing up to Terms of Service agreements.</p>
                      <p>“Small design changes, like a few extra pixels of padding or the tint of a button, can have large and unexpected repercussions. ”</p>
                      <img src={PrivacyImage} alt="Spectre dark pattern" title="Spectre dark pattern" className="img-responsive image-1 visible-xs visible-sm"/>
                  ...
                  <div className="col-md-7 col-md-pull-5  image-col hidden-xs hidden-sm">
                      ...
                      <img src={QuantImage} alt="Privacy dark pattern" title="Privacy dark pattern" className="img-responsive image-2"/>
                  </div>
              </div>
          ...
          <section id="section-3">
              ...
              <div className="row">
                  <div className="col-sm-12">
                      <div className="text-center"><img src={BiasImage} alt="Algrythmic biases" title="Algrythmic biases" className="img-responsive full-wdith pull-right"/></div>
                  </div>
              </div>
          ...
          <section id="section-4">
              <div className="row bg-4">
                  <ContentCol>
                      ...
                      <p>"Nearly every product or service that begins with the word “smart” or “personalised” ... is simply a supply-chain interface for the unobstructed flow of behavioural data on its way to predicting our futures in a surveillance economy." -Zuboff</p>
                  </ContentCol>
              </div>
              <div className="row">
                  <div className="col-sm-12">
                      <div className="text-center"><img src={PersonalizationImage} alt="Personalization" title="Personalization" className="img-responsive full-wdith pull-right" /></div>
                  </div>
              </div>
              <div className="row">
                  <ContentCol>
          ...
          <section id="section-5">
              ...
              <div className="row">
                  <div className="col-sm-12">
                      <div className="text-center"><img src={GamificationImage} alt="Gamification" title="Gamification" className="img-responsive full-wdith pull-right" /></div>
                  </div>
              </div>
              <div className="row">
                  <ContentCol>
                      ...
                      <div className="text-center"><img src={GamingImage} alt="Gamification" title="Gamification" className="img-responsive full-wdith visible-xs visible-sm"/></div>
                  ...
                  <div className="col-md-7 col-md-pull-5  image-col hidden-xs hidden-sm">
                      <img src={GamingImage} alt="Gamification" title="Gamification" className="img-responsive image-2" />
                  </div>
              </div>
          </section>
          ...
          <section id="section-6">
              <div className="row bg-6">
                  <ContentCol>
                      ...
                      <p>Spectre utilises a game consisting of famous and popular brands that are actually pre-weighted Facebook data sets. These data sets have been specifically selected to allow for a comparison with your score against 1 million + personality profile surveys conducted by the Psychometric Centre at Cambridge University. This analysis is conducted on your game score in milliseconds and creates a much more rounded OCEAN personality profile. </p>
                  </ContentCol>
              </div>
              <div className="row">
                  <div className="col-sm-12">
              ...
              <div className="row">
                  <ContentCol>
                      ...
                      <p>'OCEAN' stands for the set of traits (Openness, Contentiousness, Extroversion, Agreeableness, and Neuroticism) used by researchers to ‘measure' human personality, a process known as pyschometric profiling. Insights into your personality can help marketers and political strategists promote their products or agendas. For example, individuals high in contentiousness tend to be efficient, organized, obedient, and disciplined, so advertisements that appeal to their sense of organization, competence, and respect for authority are believed to be effective on them. By appealing to these underlying traits, psychometrically-informed ads are thought to have the potential to be more persuasive than standard ads. </p>
                      <p>
          ...
          <section id="section-7">
              <div className="row bg-7">
                  <ContentCol>
                      ...
                      <p>Specter works with behavioral psychologists at Psychometric Centre, Cambridge University, to create 40 different combination of image and slogans for creating targeted Facebook ads. The Dark ad choice of ad could also be used to influence you… as you have similar ocean traits.</p>
                      <p>
              ...
              <div className="row">
                  <div className="col-sm-12">
                      <div className="text-center"><img src={FacebookImage} alt="Facebook ad" title="Facebook ad" className="img-responsive full-wdith pull-right"/ ></div>
                  </div>
              </div>
              <div className="row">
                  <ContentCol>
                      ...
                      <div className="text-center"><a href="https://www.anotheracronym.org/newsletter/fwiw-outside-influence/"><img src={StatsImage} alt="social media political spend" title="social media political spend" className="img-responsive full-wdith visible-xs visible-sm"/></a></div>
                      <p>
                  ...
                  <div className="col-md-7 col-md-pull-5  image-col hidden-xs hidden-sm">
                      <a href="https://www.anotheracronym.org/newsletter/fwiw-outside-influence/"><img src={StatsImage} alt="social media political spend" title="social media political spend" className="img-responsive image-2"/></a>
                  </div>
              </div>
              ...
              <div className="row bg-8">
                  <ContentCol>
                     <h1>Synthesized video</h1>
                      ...
                      <p>
                          Syntheszed video means video and moving image clips in which elements of its content are purposely manipulated, sometimes using AI and machine learning. The most widely referenced category of synthesized video is the “deepfake”, in which a person in a video, usually their face or their voice, is replaced with that of another. </p>
                  </ContentCol>
              </div>
              <div className="row">
                  <div className="col-sm-12">
              ...
              <div className="row">
                  <ContentCol>
                     <p>AI and machine learning techniques have dramatically increased the quality of such manipulations, in some cases making the edits either difficult to spot or appear astoundingly real. While deepfakes can have light-hearted, humorous or benign intentions – replacing the face of a celebrity with that of another in a short clip, for example – they are also frequently used in fake celebrity or revenge pornography. There are also cases where creators of deepfakes have attempted to discredit journalists or politicians.
                      ...
                      <div className="text-center"><img src={RumorsImage} alt="Rumours and provocation" title="Rumours and provocation" className="img-responsive full-wdith visible-xs visible-sm"/></div>
                      <p>
                          At the time of writing, the remaining eight candidates for the Democratic Party nomination as well as incumbent President Trump have spent over $190M on Facebook and Google alone, with the Trump campaign running over 480,000 different ads during the campaign until now.</p>
                      <p>
                          <strong>*Note:</strong> As of November 2019, many companies, including Facebook, Twitter, and Google, are revising (or reportedly considering revising) their policies toward political advertisements on their platforms.

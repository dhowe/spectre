      ...
      <div className="PostExp">
              ...
              <div className="container">
                  <div className="row">
                      <div className="col-xs-10 col-xs-push-1 col-md-6">
                          ...
                          <p>As a reward for being a loyal follower, we can now reveal the secrets of Silicon Valley.<br/> In an age of misinformation and fake news enabled by large social media platforms, tech giants are using your personal data to influence your behaviors – both online and in the voting booth. </p>
                      </div>
                      <div className="col-xs-10 col-xs-push-1 col-md-5">
                          <img src={SpectreVideo} alt="Spectre dark pattern" title="Spectre dark pattern" className="img-responsive full-wdith"/>
                      </div>
                  </div>
              </div>
          </section>
          ...
          <section id="section-3">
              ...
              <div className="row bg-m">
                  <ContentCol>
                    <p>
                     ...
                     <p>
                         ...
                         <div className="text-center"><img src={AIImage} alt="Spectre artificial intelligence" title="Spectre artificial intelligence" className="img-responsive full-wdith visible-xs visible-sm"/></div>
                        <p>
                  ...
                  <div className="col-md-7 col-md-pull-5 image-col hidden-xs hidden-sm">
                        <img src={AIImage} alt="Spectre artificial intelligence" title="Spectre artificial intelligence" width="500px" className="img-responsive image-2"/>
                  </div>
              </div>
          </section>

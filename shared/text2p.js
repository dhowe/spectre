export default {
  openness: {
    ...
    text: [
          ...
          'You\'re more intellectually curious than most, and recognize beauty in the world. But your beliefs are unconventional, and  can tend even toward nihilism.'
        ]
  },
  ...
  extraversion: {
    ...
    text: [
          ...
          'You like to think you are energetic, exuberant and active. You enjoy being the center of attention at social occasions and like to think you\'re ready to step up to any challenge.'
        ]
  },
  ...
  neuroticism: {
    ...
    text: [
          'You rarely show negative emotions even when you feel anxious. You try to present yourself calm and resilient.',
          'You\'re emotionally stable, try to act as you\'re not bothered by things.',
